...
#define DEGREES_TO_RADIANS(x) (M_PI * (x)/180.0)
    ...
    //NSLog(@" %@",[NSValue valueWithCGSize:offSize]);
	...
	if(orientation == UIInterfaceOrientationLandscapeLeft ||
	   orientation == UIInterfaceOrientationLandscapeRight) {
		...
		middleCenter = CGPointMake(middleCenter.x,middleCenter.y-84);
		//[modalView setBounds:CGRectMake(0, 0, 480, 300)];
        [modalView setBounds:CGRectMake(0, 0, 1024, 300)];
        //[coverView setFrame:CGRectMake(0, 0, 1024, 300)];
	}
	else {
        NSLog(@"This"); 
        ...
        [modalView setBounds:CGRectMake(0, 0, 768, 460)];
		[coverView setFrame:CGRectMake(0, 0, 768, 460)];
	}
